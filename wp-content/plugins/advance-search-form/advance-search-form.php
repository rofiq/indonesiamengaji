...
class advance_search_form_widget extends WP_Widget {
	function __construct() {
    	$widget_ops = array(
			...
			'description' => esc_html__('Displays an advance search form','cactusthemes')
		);
    	parent::__construct('advance_search_form', esc_html__('Advance Search Form','cactusthemes'), $widget_ops);
	}
...
?>
	<p>
		<label for="<?php echo $this->get_field_id('title'); ?>">
                <?php echo esc_html__('Title: ','cactusthemes'); ?><input id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text"
                value="<?php echo  esc_attr($title);?>" width="100" class="widefat" />
		</label></p>
		<p>
		<label for="<?php echo $this->get_field_id('label'); ?>">
                <?php echo esc_html__('Label: ','cactusthemes'); ?>
		...
		<label for="<?php echo $this->get_field_id('default_text'); ?>">		
                <?php echo esc_html__('Default Text: ','cactusthemes'); ?><input id="<?php echo $this->get_field_id('default_text'); ?>" name="<?php echo $this->get_field_name('default_text'); ?>" type="text" value="<?php echo  esc_attr($default_text);?>" width="100" class="widefat"  />
         </label>
		 </p>
		 <p>
		<label for="<?php echo $this->get_field_id('button_text'); ?>">
                <?php echo esc_html__('Button Text: ','cactusthemes'); ?><input id="<?php echo $this->get_field_id('button_text'); ?>" name="<?php echo $this->get_field_name('button_text'); ?>" type="text" value="<?php echo  esc_attr($button_text);?>" width="100" class="widefat"  />
         </label>
		 </p>
		 <p>
		<label for="<?php echo $this->get_field_id('search_video_only'); ?>">
                <?php echo esc_html__('Only search Video Posts: ','cactusthemes'); ?><input id="<?php echo $this->get_field_id('search_video_only'); ?>" name="<?php echo $this->get_field_name('search_video_only'); ?>" type="checkbox" <?php if($search_video_only) echo 'checked="checked"';?> />
         </label>
		 </p>
		 <p>
		<label for="<?php echo $this->get_field_id('show_categories'); ?>">
                <?php echo esc_html__('Show categories list: ','cactusthemes'); ?><input id="<?php echo $this->get_field_id('show_categories'); ?>" name="<?php echo $this->get_field_name('show_categories'); ?>" type="checkbox" <?php if($show_categories) echo 'checked="checked"';?> />
         </label>
		 </p>
		 <p>
		<label for="<?php echo $this->get_field_id('suggestion'); ?>">
                <?php echo esc_html__('Search suggestion: ','cactusthemes'); ?><input id="<?php echo $this->get_field_id('suggestion'); ?>" name="<?php echo $this->get_field_name('suggestion'); ?>" type="checkbox" <?php if($suggestion) echo 'checked="checked"';?> />
         </label>
		 </p>
<?php
    }
