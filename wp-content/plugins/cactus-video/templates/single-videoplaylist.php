...
<?php }
$c_jw7_ex ='';
if(($using_jwplayer_param == 1 && (strpos($url, 'youtube.com') !== false) && function_exists('cactus_jwplayer7')) || ($jwplayer_select =='jwplayer_7' && $file !='' && function_exists('cactus_jwplayer7'))){
	$c_jw7_ex = '1';
	ob_start();
	cactus_jwplayer7();
    ...
    <div class="videov2-style playlist-style dark-div" <?php echo $css_bg;?>>
        ...
        <div class="style-post">
            <div class="cactus-post-format-video-wrapper">                                            
                ...
                <?php videopro_post_toolbar(get_the_ID(), 'video');?>                                                   
            </div>
        </div>
	<?php }
    }
