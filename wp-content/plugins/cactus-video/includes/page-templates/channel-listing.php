                    ...
                    <div class="main-content-col-body">
                        ...
                        <div class="cactus-listing-wrap">
                            <div class="cactus-listing-config style-channel"> <!--addClass: style-1 + (style-2 -> style-n)-->
                                <div class="cactus-sub-wrap">
									<?php if ( have_posts() ) : ?>
										<?php while ( have_posts() ) : the_post(); ?>
                                            <?php include ct_video_get_plugin_url() . 'templates/loop/content-channel-listing.php'; ?>
                                ...
                                <?php videopro_paging_nav('.cactus-listing-config.style-channel .cactus-sub-wrap', ct_video_get_plugin_url() . 'templates/loop/content-channel-listing.php', false, $list_query); ?>
