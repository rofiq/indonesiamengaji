                    ...
                    <div class="main-content-col-body">
						...
						<script type="text/javascript">
						 var cactus = {"ajaxurl":"<?php echo admin_url( 'admin-ajax.php' );?>","query_vars":<?php echo str_replace('\/', '/', json_encode($args)) ?>,"current_url":"<?php echo esc_url(home_url($wp->request));?>" }
                            ...
                            <?php videopro_paging_nav('.cactus-listing-wrap.playlist-list .cactus-sub-wrap', ct_video_get_plugin_url() . 'templates/loop/content-playlist.php', false, $list_query); ?>
                        <?php }
						wp_reset_postdata();
                        if($it>0){
                            $wp_query = $main_query;
