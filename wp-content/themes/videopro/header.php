...
?>
<div id="body-wrap" class="<?php if($videopro_layout == 'boxed'){ echo 'cactus-box ';}if($videopro_layout == 'boxed' && get_post_format(get_the_ID())=='video' && $videopro_post_video_layout == '2'){ echo ' video-v2-setbackground ';}?>">
    <div id="wrap">
    	<?php 
