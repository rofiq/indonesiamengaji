...
if(!function_exists('videopro_custom_css')){
	...
	/*custom background*/
		if(isset($custom_background['background-color'])|| isset($custom_background['background-image'])){
			$custom_css.= '#body-wrap{background:';
			...
			$custom_css.= ';}';
			$custom_css.= '#wrap {background-color:#FFFFFF;}';
		}
	/*custom background*/
