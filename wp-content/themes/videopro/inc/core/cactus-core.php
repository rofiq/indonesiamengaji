...
function videopro_acplugins($plugins) {
     ...
     */
    $config = array(
        'domain'            => 'financecorp',           // Text domain - likely want to be the same as your theme.
...
function videopro_color_widget_add_custom_fields() {
	...
	<input class='color {required:false}' type='text' name='".$id_disp."-ct_color' id='".$id_disp."-ct_color' value='".$value."' />
...
function videopro_bgcolor_widget_add_custom_fields() {
	...
	<input class='color {required:false} ' type='text' name='".$id_disp."-ct_bgcolor' id='".$id_disp."-ct_bgcolor' value='".$value."'/>
	<script type='text/javascript'>
...
if(!is_admin()){
	...
	function videopro_hook_before_widget($params){
		...
		if(!empty( $videopro_wl_color_options[$id ] ) || !empty( $videopro_wl_bgcolor_options[$id ] )){
			//$params[0]['before_widget'] .= '<style scoped>#'.$id.' .ct-sub-w-title{color:#'.$videopro_wl_color_options[$id ].' !important; background:#'.$videopro_wl_bgcolor_options[$id ].' !important}</style>';
			$css_style = '<style>#'.$id.' .ct-sub-w-title{color:#'.$videopro_wl_color_options[$id ].' !important; background:#'.$videopro_wl_bgcolor_options[$id ].' !important}</style>';
...
?>
	...
	<meta property="og:type" content="<?php echo esc_attr($post_format);?>"/>
...
<?php
	...
	?>
	<meta name="description" content="<?php echo esc_attr(strip_shortcodes($description));?>"/>
	<?php
}
