    ...
    if($enable_switcher_toolbar != 'off'){
        ...
        <div class="view-mode">
            <div class="view-mode-switch ct-gradient">
                <div data-style="" class="view-mode-style-1 <?php if($videopro_blog_layout == 'layout_1' || $videopro_blog_layout == ''){?>active<?php }?>"><img src="<?php echo get_template_directory_uri(); ?>/images/2X-layout1.png" alt=""></div>
                <div data-style="style-2" class="view-mode-style-2 <?php if($videopro_blog_layout == 'layout_3'){?>active<?php }?>"><img src="<?php echo get_template_directory_uri(); ?>/images/2X-layout2.png" alt=""></div>
                <div data-style="style-3" class="view-mode-style-3 <?php if($videopro_blog_layout == 'layout_2'){?>active<?php }?>"><img src="<?php echo get_template_directory_uri(); ?>/images/2X-layout3.png" alt=""></div>
            </div>
        </div>
    <?php }?>
</div>
