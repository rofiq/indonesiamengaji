                    ...
                    <?php while ( have_posts() ) : the_post();
						...
						<div class="channel-menu">
							<div class="channel-menu-content">
								<div class="channel-menu-item heading-font font-size-3 <?php if( (!isset($_GET['view']) &&  ($videopro_cpage =='')) || ( (isset($_GET['view']) && $_GET['view'] =='videos') &&  ($videopro_cpage =='')) || ((isset($_GET['view']) && $_GET['view'] =='')&&  ($videopro_cpage ==''))){?> active <?php }?>">
								...
								<div class="channel-menu-item heading-font font-size-3 <?php if((isset($_GET['view']) && $_GET['view'] =='discussion') || ($videopro_cpage !='')){?> active <?php }?>">
